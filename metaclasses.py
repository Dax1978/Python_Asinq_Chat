...
# Метакласс для проверки objServer
class ServerMaker(type):
    def __init__(self, clsname, bases, dct):
        ...
        print('Методы objServer:', methods)
        print('Атрибуты objServer:', attrs)
...
# Метакласс для проверки корректности objClient
class ClientMaker(type):
    def __init__(self, clsname, bases, dct):
        ...
        print('Методы objClient:', methods)
