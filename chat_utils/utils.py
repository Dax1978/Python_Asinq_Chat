...
def get_addr_port(isServer = True):
    ...
    if not 1023 < namespace.p < 65536:
        ...
        if isServer:
            ...
            if namespace.m not in ('listen', 'send'):
                LOGGER_CLIENT.critical(f'Указан недопустимый режим работы {namespace.m}, '
    ...
    return namespace.a, namespace.p, namespace.m, port_corr
