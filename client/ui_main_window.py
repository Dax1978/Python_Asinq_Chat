...
from client.ui_main_window_conv import Ui_MainClientWindow
from client.ui_add_contact import AddContactDialog
from client.ui_del_contact import DelContactDialog
...
class ClientMainWindow(QMainWindow):
    '''
    Класс - основное окно пользователя, содержащий всю основную логику работы клиентского модуля.
    Конфигурация окна создана в QTDesigner и загружается из конвертированого файла main_window_conv.py
    '''
    ...
    def message(self, message):
        '''
        Слот обработчик поступаемых сообщений, выполняет дешифровку поступаемых сообщений и их сохранение в истории сообщений
        Запрашивает пользователя если пришло сообщение не от текущего собеседника. При необходимости меняет собеседника
        '''
